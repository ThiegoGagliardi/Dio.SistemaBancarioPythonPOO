...
class Saque(Transacao):
    ...
    def __str__(self) :
        return f"""Saque no valor de R$ {"{:.2f}".format(self._valor)}. realizado em {datetime.now()}, saldo alterado de R$ {"{:.2f}".format(self._saldo_anterior)} para R$ {"{:.2f}".format(self._saldo_atual)}."""    